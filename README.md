...
<p>To delete a food from the diary, enter "delete" followed by "keyword|id" where keyword is for general items you want to delete that has those keywords in it and ID is for the specific element with that ID. This will delete the food item that matches your input. d) Print Current Diary (print) To print the user nutrition diary, enter "print". e) Quit (quit) Enter "quit" to exit the menu.</p>
<ol start="2">
<li>
